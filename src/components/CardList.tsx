...
export default function CardList() {
    ...
    return (
        <div className="max-w-7xl mx-auto p-4"> {/* ページ全体の中央寄せ */}
            {/* FilterSort コンポーネントを div で囲んで中央寄せと余白を設定 */}
            ...
            <div className="grid gap-4">
                {items.map((item, index) => (
                    <div
                        ...
                        className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 flex h-48 max-w-5xl mx-auto w-full" // カード型コンポーネントを中央寄せ、最大幅設定
                    >
                        {/* 左列：画像 (w-1/3 を w-1/4 に変更) */}
