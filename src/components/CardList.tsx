...
export default function CardList() {
  ...
  if (loading) return <div className="w-[1000px] mx-auto p-4 text-center">読み込み中...</div>;
  if (error) return <div className="w-[1000px] mx-auto p-4 text-center text-red-500">{error}</div>;
